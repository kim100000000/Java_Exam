...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        List<String> highSalaryIT = employees.stream()
                ...
                .map(Employee::getName)
                .collect(Collectors.toList());   // (Java 16+면 .toList()도 OK)
        ...
        System.out.println(allNames);              // "홍길동, 김철수, 이영희, 박민수, 최지현, 한석봉"
        System.out.println(highSalaryIT);          // [이영희, 홍길동, 한석봉]
        System.out.println(averageSalaryByDept);   // {HR=3250.0, IT=6000.0, 영업=4000.0}
    }
}
